        ...
        <thead className="bg-[var(--color-gray)] border-b border-[var(--color-gray)]">
          <tr>
            {columns.map((col) => (
              <th
                key={col.key}
                className="px-2 2xl:px-4 py-2 2xl:py-3 font-normal text-left whitespace-nowrap font-mono text-[14px]"
              >
                {col.label}
              </th>
            ))}
          ...
          <tr className="bg-white border-b border-[var(--color-gray)]">
            {columns.map((col) => (
              <th key={col.key} className="px-1 2xl:px-2 py-1 2xl:py-2">
    ...
    if (row.status === "done" || row.status === "canceled") {
      ...
      return (
        <div className="flex items-center gap-1 lg:gap-2">
          ...
          <span className="text-[12px] lg:text-[14px] font-mono text-[12px]">
